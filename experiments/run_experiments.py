...
if __name__ == "__main__":
    ...
    if "boostcentralheft" in experiment_schedulers:
        ...
        sim.batch_exec_log.to_csv(OUTPUT_FILE_NAMES["boostcentralheft"] + "batch_log.csv")
        ...
        worker_model_histories.to_csv(OUTPUT_FILE_NAMES["boostcentralheft"] + "model_history_log.csv")
